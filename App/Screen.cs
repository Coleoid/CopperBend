...
namespace CopperBend.App
{
    ...
    public abstract class Screen
    {
        ...
        public Screen()
        {
            ...
            GameLoop.RootConsole.OnResize += onResize;
        }

        public void Show()
        {
            if (Shown) throw new Exception("Screen already shown");
        ...
        {
            return () => { return GameLoop.RootConsole.Width - subtract; };
        }
        ...
        {
            return () => { return GameLoop.RootConsole.Height - subtract; };
        }
        ...
        {
            return () => { return GameLoop.RootConsole.Width / 2; };
        }
        ...
        {
            return () => { return GameLoop.RootConsole.Height / 2; };
        }
        ...
        protected void addPanel(Panel panel)
        {
            if (!panels.Contains(panel))
                ...
                Console.WriteLine("WARNING: Tried to add a panel to a screen twice, ignoring second add.  This is a bug...");
        }
